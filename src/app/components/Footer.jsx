  ...
  return (
    <footer className="relative bg-gray-50 border-t border-gray-200 py-10 px-6 mt-20">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="absolute left-1/2 -top-4 transform -translate-x-1/2 bg-white border border-gray-200 rounded-full p-2 shadow-sm hover:shadow-md transition"
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-gray-600 text-sm">
        <p>© {new Date().getFullYear()} Jared Harrison</p>
